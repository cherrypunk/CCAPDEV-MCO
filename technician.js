$(document).ready(function () {
    ...
    */
                ...
                for (let k = 0; k <= data.reservations.length; k++) {
                    if (data.reservations[k]["time_of_reservation"] === "07:30 a.m. - 09:00 a.m.") {
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot1").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete1\">Delete</button>");
                        }
                        ...
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot2").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete2\">Delete</button>");
                        }
                        ...
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot3").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete3\">Delete</button>");
                        }
                        ...
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot4").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete4\">Delete</button>");
                        }
                        ...
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot5").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete5\">Delete</button>");
                        }
                        ...
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot6").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete6\">Delete</button>");
                        }
                        ...
                        if (data.reservations[k]["is_anon"] === true) {
                            ...
                            $("#slot7").html("<a target=\"_blank\" href=\"/view-profile/" + data.reservations[k]['reservee'] + "\" class=\"leftlinks deleteright\">" + data.reservations[k]['name'] + "</a> <button type=\"button\" class=\"tech-delete btn btn-dark btn-sm\" id=\"delete7\">Delete</button>");
                        }
    ...
    $("#reservebtn").click(function () { //no button
        ...
        console.log(name);*/
        $.post(
            "/make_reservation_technician",
            { input: { seat: seat, dateReserved: mon + " " + date, labName: currentLab, time: timecomp, is_anon: ano, name: name } },
            function (data, status) {
                if (status === 'success') {
                    alert(data.response);
                    location.reload();
    ...
    $("#slot1").on('click', '#delete1', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "07:30 a.m. - 09:00 a.m." } },
            function (data, status) {
                if (status === 'success') {
    ...
    $("#slot2").on('click', '#delete2', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "09:15 a.m. - 10:45 a.m." } },
            function (data, status) {
                if (status === 'success') {
    ...
    $("#slot3").on('click', '#delete3', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "11:00 a.m. - 12:30 p.m." } },
            function (data, status) {
                if (status === 'success') {
    ...
    $("#slot4").on('click', '#delete4', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "12:45 p.m. - 02:15 p.m." } },
            function (data, status) {
                if (status === 'success') {
    ...
    $("#slot5").on('click', '#delete5', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "02:30 p.m. - 04:00 p.m." } },
            function (data, status) {
                if (status === 'success') {
    ...
    $("#slot6").on('click', '#delete6', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "04:15 p.m. - 05:45 p.m." } },
            function (data, status) {
                if (status === 'success') {
    ...
    $("#slot7").on('click', '#delete7', function () {
        $.post(
            "/delete_reservation",
            { input: { seat: seat, date: date, month: month, currentLab: currentLab, time: "06:00 p.m. - 07:30 p.m." } },
            function (data, status) {
                if (status === 'success') {
